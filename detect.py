...
if __name__== "__main__":
    ...
    file_path= "datasets\\images\\test\\fb9ccfdc-137.jpeg"
    # file_path= "datasets\\\car-number-plate\\videos\\traffic.mp4"
    ...
    if file_extension in [".jpg", ".jpeg", ".png"]:
        ...
        number_plate_list= detect_number_plate(image, model, display=True)
        cv2.imshow("image", image)
        cv2.waitKey(0)
        # if there are any number plates detected, recognize the
        ...
        while True:
            ...
            number_plate_list= detect_number_plate(frame, model)
